...
export const projects: Project[] = ([
  ...
  },
  {
    ...
    year: "2026",
    summary: "A responsive executive management platform for monitoring priorities, managing tasks and issues, coordinating meetings and follow-up, and controlling administrative access.",
    challenge: "EMS brings executive dashboards, operational records, meeting follow-up and administrative permissions into one product.",
    outcome: "Executives and managers can review priorities, open the records behind them and continue the same workflows across Desktop, Tablet and Mobile.",
    role: "Product design · information architecture · design system",
    scope: "Dashboards, tasks, issues, meetings, follow-up and administration",
    platform: "Responsive enterprise web · Desktop, Tablet, Mobile",
    status: "Responsive platform · Shared design system · High-fidelity prototype",
    method: "EMS connects executive dashboards, operational records, meeting follow-up and administrative permissions in one responsive workspace.",
    primaryUsers: [
    ...
    executiveSummary: {
      problem: "Executives and managers use EMS to review priorities, open operational records and follow work across tasks, issues and meetings.",
      approach: "Shared search, filters, ownership, status, priority and permission patterns keep those workflows consistent across Desktop, Tablet and Mobile.",
      result: "Dashboards, operational records, meetings and administration are available through one responsive executive workspace.",
    },
    evidence: [
      { value: "4", label: "core workflows", detail: "Tasks, issues, meetings and administration are organized within one executive management platform." },
      { value: "3", label: "responsive contexts", detail: "Desktop, Tablet and Mobile provide the same records and actions in layouts suited to each screen." },
    ],
    chapters: [
