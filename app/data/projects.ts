...
export const projects: Project[] = ([
  ...
  },
  {
    ...
    year: "2026",
    summary: "Designed a responsive enterprise BI workspace that connects pharmacy revenue, operations, inventory exposure and referral performance in one decision journey.",
    ...
    outcome: "A role-aware analytics product that preserves one decision model across Desktop, Tablet and Mobile in Light and Dark themes.",
    ...
    status: "Design complete · responsive interactive prototype",
    method: "Decision architecture · responsive information hierarchy · data visualisation · interactive prototyping",
    primaryUsers: [
    ...
    executiveSummary: {
      ...
      result: "A coherent enterprise BI prototype that keeps the Pharmacy decision journey intact while density, navigation and interaction adapt across Desktop, Tablet and Mobile.",
    },
    evidence: [
      ...
      { value: "3 × 2", label: "breakpoints and themes", detail: "Desktop, Tablet and Mobile preserve the same decision model in both Light and Dark." },
    ],
    chapters: [
    ...
    tags: ["Enterprise BI", "Data visualisation", "Responsive systems"],
    theme: "navy",
    visual: "pharmacy-bi",
  ...
  },
  {
    ...
    thumbnail: "/video/daoud-tycoons-video-poster.jpg",
    theme: "tycoon",
    visual: "daoud",
    ...
    screens: [
      ...
      { title: "DI LORENZO Blouson — size L selected", image: "/screens/daoud-tycoons/pdp-blouson-selected.webp", fullImage: "/screens/daoud-tycoons/pdp-blouson-selected.png", device: "tablet" },
